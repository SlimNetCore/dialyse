      ...
      <section class="login-right">
        ...
        <mat-card class="login-card">
          <mat-card-header>
            ...
            <mat-card-subtitle
            >Identifiez votre centre, puis ouvrez votre espace opérateur.
            </mat-card-subtitle
            >
          </mat-card-header>
  ...
  styles: [
    `
      ...
      .login-left {
        ...
        linear-gradient(
          145deg,
          color-mix(in srgb, var(--app-bg) 92%, var(--app-bg-alt)),
          color-mix(in srgb, var(--app-bg) 78%, var(--app-bg-alt))
        );

        ...
        <table mat-table [dataSource]="rows()" class="w100">
          <ng-container matColumnDef="code">
            <th mat-header-cell *matHeaderCellDef>
              <div class="th-wrap" [class.open]="isFilterOpen('code')">
                <div class="th-top">
                  <span>{{ 'PEC_LIST.COL_CODE' | translate }}</span>
                  <mat-icon
                    class="filter-ind"
          ...
          <ng-container matColumnDef="nom">
            <th mat-header-cell *matHeaderCellDef>
              <div class="th-wrap" [class.open]="isFilterOpen('nom')">
                <div class="th-top">
                  <span>{{ 'PEC_LIST.COL_PATIENT' | translate }}</span>
                  <mat-icon
                    class="filter-ind"
          ...
          <ng-container matColumnDef="assurance">
            <th mat-header-cell *matHeaderCellDef>
              <div class="th-wrap" [class.open]="isFilterOpen('assurance')">
                <div class="th-top">
                  <span>{{ 'PEC_LIST.COL_ASSURANCE' | translate }}</span>
                  <mat-icon
                    class="filter-ind"
                    [class.active]="isColumnFiltered('assurance')"
                    (click)="toggleFilterPanel('assurance', $event)"
                  >{{ isColumnFiltered('assurance') ? 'filter_alt' : 'filter_alt_off' }}
                  </mat-icon>
                </div>
                <div class="th-filter">
                  <app-column-filter-renderer
                    type="text"
                    labelKey="PEC_LIST.COL_ASSURANCE"
                    [value]="columnFilterValue('assurance')"
          ...
          <ng-container matColumnDef="debut">
            <th mat-header-cell *matHeaderCellDef>
              <div class="th-wrap" [class.open]="isFilterOpen('debut')">
                <div class="th-top">
                  <span>{{ 'PEC_LIST.COL_DEBUT' | translate }}</span>
                  <mat-icon
                    class="filter-ind"
                    [class.active]="isColumnFiltered('debut')"
                    (click)="toggleFilterPanel('debut', $event)"
                  >{{ isColumnFiltered('debut') ? 'filter_alt' : 'filter_alt_off' }}
                  </mat-icon>
                </div>
                <div class="th-filter">
                  <app-column-filter-renderer
                    type="date"
                    labelKey="PEC_LIST.COL_DEBUT"
                    [value]="columnFilterValue('debut')"
          ...
          <ng-container matColumnDef="fin">
            <th mat-header-cell *matHeaderCellDef>
              <div class="th-wrap" [class.open]="isFilterOpen('fin')">
                <div class="th-top">
                  <span>{{ 'PEC_LIST.COL_FIN' | translate }}</span>
                  <mat-icon
                    class="filter-ind"
                    [class.active]="isColumnFiltered('fin')"
                    (click)="toggleFilterPanel('fin', $event)"
                  >{{ isColumnFiltered('fin') ? 'filter_alt' : 'filter_alt_off' }}
                  </mat-icon>
                </div>
                <div class="th-filter">
                  <app-column-filter-renderer
                    type="date"
                    labelKey="PEC_LIST.COL_FIN"
                    [value]="columnFilterValue('fin')"
          ...
          <ng-container matColumnDef="statut">
            <th mat-header-cell *matHeaderCellDef>
              <div class="th-wrap" [class.open]="isFilterOpen('statut')">
                <div class="th-top">
                  <span>{{ 'PEC_LIST.COL_STATUS' | translate }}</span>
                  <mat-icon
                    class="filter-ind"
                    [class.active]="isColumnFiltered('statut')"
                    (click)="toggleFilterPanel('statut', $event)"
                  >{{ isColumnFiltered('statut') ? 'filter_alt' : 'filter_alt_off' }}
                  </mat-icon>
                </div>
                <div class="th-filter">
                  <app-column-filter-renderer
                    type="enum"
                    labelKey="PEC_LIST.COL_STATUS"
            ...
            <td mat-cell *matCellDef="let r">
              <span class="status-badge">{{ r.STATUT || r.statut }}</span>
            </td>
          </ng-container>
          ...
          <tr
            ...
            *matRowDef="let row; columns: displayedColumns()"
            [attr.data-row-key]="
              row.PATIENT_ID || row.patient_id || row.CODE_PATIENT || row.code_patient
            "
          ></tr>

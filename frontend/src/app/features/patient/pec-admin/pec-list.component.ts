  ...
  template: `
    <mat-card>
      ...
      <table mat-table [dataSource]="rows()" class="w100">
        ...
        <ng-container matColumnDef="statut"><th mat-header-cell *matHeaderCellDef>{{ 'PEC_LIST.COL_STATUS' | translate }}</th><td mat-cell *matCellDef="let r">{{r.STATUT || r.statut}}</td></ng-container>
